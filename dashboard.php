...
<div class="w3-row-padding">
	<div class="w3-col s8">
		...
		<?php
			$jmlsup = mysqli_num_rows(mysqli_query($link, "SELECT * FROM tb_supplier"));
			$jmlpel = mysqli_num_rows(mysqli_query($link, "SELECT * FROM tb_pelanggan"));
			$jmlpj = mysqli_num_rows(mysqli_query($link, "SELECT * FROM tb_penjualan"));
			$jmlbrg = mysqli_num_rows(mysqli_query($link, "SELECT * FROM tb_barang"));
		?>
	...
	<div class="w3-col s4 w3-card">
		...
		<table class='w3-table w3-tiny w3-striped'>
		<?php
			$rlaris = mysqli_query($link, "SELECT * FROM barang_laris 
		...
		<table class='w3-table w3-tiny w3-striped'>
		<?php
			$rlog = mysqli_query($link, "SELECT * FROM tb_log 
