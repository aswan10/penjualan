<?php
	...
	switch ($act) {
			...
			echo"<div class='w3-row-padding'>
				...
				<div style='border-bottom:1px dashed #ccc;'></div><br>";
					echo"<table class='w3-table w3-tiny w3-hoverable tbl'>
						...
						$sql_tmp = mysqli_query($link, "SELECT a.kode_barang, a.qty, a.harga, b.nama_barang, a.disc 
		...
		case "list":
			...
			$gtot = 0;
			$ptot = 0;
			$sqltotal = mysqli_query($link, "SELECT no_transaksi, potongan FROM tb_penjualan");
			$c = mysqli_num_rows($sqltotal);
			if ($c > 0) {

				while($tot = mysqli_fetch_assoc($sqltotal)) {
...
<script type="text/javascript">
	$(function(){
		...
		<?php
			$sqlTags = mysqli_query($link, "SELECT * FROM tb_pelanggan 
