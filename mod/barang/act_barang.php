<?php
	...
	if($mod == "barang" AND $act == "simpan")
	{
		...
		if(empty($kode_barang)) {
			$q = mysqli_query($link, "SELECT MAX(RIGHT(kode_barang,10)) AS kodebrg
  		...
  		if(empty($lokasi_file))
		{
			...
			mysqli_query($link, "INSERT INTO tb_barang(kode_barang, 
												nama_barang, 
												deskripsi, 
												tgl_input, 
												harga_beli, 
			...
			else
			{
				mysqli_query($link, "INSERT INTO tb_barang(kode_barang, 
											...
											VALUES ('$kode_barang', 
												...
												'$jml_stok', 
												'$satuan',
												'$image_name')") or die(mysqli_error());
				flash('example_message', '<p>Berhasil menambah data biaya.</p>' );
	...
	elseif ($mod == "barang" AND $act == "edit") 
	{
  		...
  		if(empty($lokasi_file))
		{
			...
			mysqli_query($link, "UPDATE tb_barang SET nama_barang= '$nama_barang', 
											deskripsi= '$deskripsi', 
											tgl_input= '$tgl_input', 
	...
	{
		mysqli_query($link, "DELETE FROM tb_barang WHERE kode_barang = '$_GET[id]'") or die(mysqli_error());
