	...
	switch ($act) {
		...
		case "form" :
			...
			echo"<div class='w3-row-padding'>
				...
				<div class='w3-col s9'>
					...
					$sql = mysqli_query($link, "SELECT a.*, b.nama_barang, b.satuan 
		...
		case "detail" :
			...
			if(isset($_GET['id']))
			{
				...
				$sqltrans = mysqli_query($link, "SELECT * FROM tb_pembelian WHERE no_faktur = '$_GET[id]'") or die(mysqli_error());
...
<script type="text/javascript">
	$(function(){
		...
		<?php
			$sqlTags = mysqli_query($link, "SELECT * FROM tb_barang 
	    ...
	    <?php
			$sqlTags = mysqli_query($link, "SELECT * FROM tb_supplier 
