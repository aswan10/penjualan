...
<nav id="left-nav" class="w3-sidenav w3-small w3-light-grey w3-card-4" style="width:250px;">
  ...
  <!--onmouseout="w3_hide_scroll()" onmouseover="w3_show_scroll()"-->
    <?php
        $sql_menu = mysqli_query( $link, "SELECT * FROM menu ORDER BY posisi ASC") or die(mysqli_error());
        while ($mn = mysqli_fetch_assoc($sql_menu)) {
            ...
            $sql_sub = mysqli_query($link, "SELECT * FROM modul WHERE id_menu = '$mn[id_menu]' ORDER BY posisi ASC") or die(mysqli_error());
